"""Define all the data classes using Pydantic"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/00_dataclasses.ipynb.

# %% auto 0
__all__ = ['AppTheme', 'ModelConfig', 'ChatAppConfig', 'BaseChatApp', 'foo']

# %% ../../nbs/00_dataclasses.ipynb 4
# Load environment variables from .env file
load_dotenv()

# %% ../../nbs/00_dataclasses.ipynb 7
